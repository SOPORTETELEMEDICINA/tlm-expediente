...
public class CatalogoDiaException extends GenericException {
    ...
    public CatalogoDiaException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatalogoDiaException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
