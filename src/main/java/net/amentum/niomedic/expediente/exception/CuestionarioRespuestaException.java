...
public class CuestionarioRespuestaException extends GenericException {
    ...
    public CuestionarioRespuestaException(String message, String layer, String action) {
        super(message);
        this.layer = layer;
        this.action = action;
    }

    public CuestionarioRespuestaException(Exception ex, String message, String layer, String action) {
        super(ex, message);
        this.layer = layer;
        this.action = action;
    }
