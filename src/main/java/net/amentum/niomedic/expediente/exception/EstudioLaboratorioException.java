...
public class EstudioLaboratorioException extends GenericException {
    ...
    public EstudioLaboratorioException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public EstudioLaboratorioException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
