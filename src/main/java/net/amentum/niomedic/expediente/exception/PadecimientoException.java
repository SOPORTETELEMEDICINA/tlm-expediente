...
public class PadecimientoException extends GenericException {
    ...
    public PadecimientoException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public PadecimientoException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
