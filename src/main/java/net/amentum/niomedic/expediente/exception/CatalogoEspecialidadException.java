...
public class CatalogoEspecialidadException extends GenericException {
    ...
    public CatalogoEspecialidadException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatalogoEspecialidadException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
