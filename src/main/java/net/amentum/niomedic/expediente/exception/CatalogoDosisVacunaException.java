...
public class CatalogoDosisVacunaException extends GenericException {
    ...
    public CatalogoDosisVacunaException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatalogoDosisVacunaException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
