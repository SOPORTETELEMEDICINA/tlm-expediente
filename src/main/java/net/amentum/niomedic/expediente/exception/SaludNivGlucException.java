...
public class SaludNivGlucException extends GenericException {
    ...
    public SaludNivGlucException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public SaludNivGlucException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
