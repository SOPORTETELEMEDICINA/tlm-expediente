...
public class TurnosLaboralesException extends GenericException {
    ...
    public TurnosLaboralesException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public TurnosLaboralesException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
