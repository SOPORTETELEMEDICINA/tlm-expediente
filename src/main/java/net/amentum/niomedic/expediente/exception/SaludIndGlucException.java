...
public class SaludIndGlucException extends GenericException {
    ...
    public SaludIndGlucException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public SaludIndGlucException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
