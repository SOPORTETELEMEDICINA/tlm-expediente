...
public class CatalogoVacunaException extends GenericException {
    ...
    public CatalogoVacunaException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatalogoVacunaException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
