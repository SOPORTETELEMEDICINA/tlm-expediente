...
public class SaludNivPreartException extends GenericException {
    ...
    public SaludNivPreartException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public SaludNivPreartException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
