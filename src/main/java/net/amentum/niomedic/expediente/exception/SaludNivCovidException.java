...
public class SaludNivCovidException extends GenericException {
    ...
    public SaludNivCovidException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public SaludNivCovidException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
