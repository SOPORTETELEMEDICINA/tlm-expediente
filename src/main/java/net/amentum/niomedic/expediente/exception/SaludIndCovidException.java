...
public class SaludIndCovidException extends GenericException {
    ...
    public SaludIndCovidException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public SaludIndCovidException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
