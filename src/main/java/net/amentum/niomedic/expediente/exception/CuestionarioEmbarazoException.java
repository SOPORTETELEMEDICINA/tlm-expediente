...
public class CuestionarioEmbarazoException extends GenericException {
    ...
    public CuestionarioEmbarazoException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CuestionarioEmbarazoException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
