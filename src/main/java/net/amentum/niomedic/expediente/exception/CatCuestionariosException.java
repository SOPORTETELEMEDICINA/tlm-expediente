...
public class CatCuestionariosException extends GenericException {
    ...
    public CatCuestionariosException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatCuestionariosException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
