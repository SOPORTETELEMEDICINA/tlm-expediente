...
public class CatalogoTipoEventoException extends GenericException {
    ...
    public CatalogoTipoEventoException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public CatalogoTipoEventoException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
