...
public class SaludIndNutriException extends GenericException {
    ...
    public SaludIndNutriException(Exception ex, String message, String layer, String action){
        super(ex,message);
        this.layer = layer;
        this.action = action;
    }

    public SaludIndNutriException(String message, String layer, String action){
        super(message);
        this.layer = layer;
        this.action = action;
    }
