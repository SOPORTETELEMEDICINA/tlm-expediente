...
public interface CatCie9Service {
   ...
   Page<CatCie9FiltradoView> getCatCie9Search(String datosBusqueda, Boolean activo, Integer page, Integer size, String orderColumn, String orderType) throws CatCie9Exception;
